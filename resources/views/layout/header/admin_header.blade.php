...
<div id="wrapper">
    ...
    <div id="sidebar-wrapper">
        <div class="logo_dash_box">
            ...
            <img src="{{url('assets/img/Banjari_logo.png')}}">
            </div>
            <div class="company_name">Banjari Travels</div>
        </div>
        <ul class="sidebar-nav" style="margin-left:0;">
            ...
            <li><a href="{{url('user_master')}}" title="Users"><i class="fa fa-users"
                                                                  aria-hidden="true"></i><span
                            style="margin-left:10px;"> Users</span></a></li>
            <li><a href="{{url('tour')}}" title="Itineraries"><i class="fa fa-map-o"
                                                                  aria-hidden="true"></i><span
                            style="margin-left:10px;"> Itineraries</span></a></li>
            <li><a href="{{url('enquiry')}}" title="Enquiries"><i class="fa fa-child"
                                                           aria-hidden="true"></i><span
                            style="margin-left:10px;"> Enquiries</span></a></li>
            <li><a href="{{url('place')}}" title="Places"><i class="fa fa-map-marker"
                                                             aria-hidden="true"></i><span
                            style="margin-left:10px;"> Places</span></a></li>
            <li><a href="{{url('lead/1/filter')}}" title="Leads"><i class="fa fa-list-alt"
                                                                  aria-hidden="true"></i><span
