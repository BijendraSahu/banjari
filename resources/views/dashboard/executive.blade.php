        ...
        <div class="col-md-12 seperate ">
            ...
            <table width="100%" border="0" align="left">
                ...
                <tr>
                    ...
                    {{--<td width="19%" align="center"><a href="home_marketing" class="a_txt"><i--}}
                                    {{--class="fa awesome_style animated-hover faa-tada faa-fast fa-reply-all"></i> <br>--}}
                            {{--<h4>My Leads</h4></a></td>--}}
                    <td width="19%" align="center"><a href="{{url('lead/1/filter')}}" class="a_txt"><i
                                    class="fa awesome_style animated-hover faa-tada faa-fast fa-users"></i> <br>
                            <h4>All Leads</h4></a></td>
                    <td width="19%" align="center"><a href="tour" class="a_txt"><i
